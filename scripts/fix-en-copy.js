...
const globalPairs = [
  ['<span class="footer-name">日医通</span>', '<span class="footer-name">JMedPass</span>'],
...
patchFile('en/ovarian-rejuvenation.html', [
  ...
  ['          <h4>🌸 日医通干细胞卵巢疗法优势</h4>', '          <h4>🌸 Why our ovarian rejuvenation programme stands out</h4>'],
...
patchFile('en/stem-cell-anti-aging.html', [
  ...
  ['      <h3 style="font-family:\'Noto Serif SC\',serif;color:white;font-size:1.1rem;margin-bottom:28px;text-align:center">日医通标准 vs 国际常规对比</h3>', '      <h3 style="font-family:\'Noto Serif SC\',serif;color:white;font-size:1.1rem;margin-bottom:28px;text-align:center">Our treatment standard vs. common international practice</h3>'],
  ...
  ['            <div class="cb-vals"><span class="cb-jp">日医通：2.5–3亿</span><span>国际：5000万–1亿</span></div>', '            <div class="cb-vals"><span class="cb-jp">Ours: 250–300M</span><span>Common: 50–100M</span></div>'],
  ...
  ['            <div class="cb-vals"><span class="cb-jp">日医通：≤3代</span><span>国际：6–8代</span></div>', '            <div class="cb-vals"><span class="cb-jp">Ours: ≤3 passages</span><span>Common: 6–8 passages</span></div>'],
  ...
  ['            <div class="cb-vals"><span class="cb-jp">日医通：100% 新鲜</span><span>国际：冷冻保存</span></div>', '            <div class="cb-vals"><span class="cb-jp">Ours: fresh-cell handling</span><span>Common: frozen storage</span></div>'],
  ['        <p>日医通专属顾问收集完整健康档案，与日本医生进行初诊评估，确认适应性</p>', '        <p>A dedicated care consultant gathers your health profile and coordinates an initial review with a Japanese doctor.</p>'],
  ...
  ['        <p>治疗后定期追踪各项指标变化，日医通中文团队持续陪伴，优化长期效果</p>', '        <p>After treatment, the team tracks key indicators and follows up regularly to support long-term outcomes.</p>'],
